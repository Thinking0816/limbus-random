...
const sinnerData = {
    ...
    "파우스트": [
        ...
        {name: "[ 거미집 약지 제자 ] 파우스트", rank: 3, img: "02_faust_spider.png"}
    ],
    "돈키호테": [
    ...
    "뫼르소": [
        ...
        { name: "[ 약지 야수파 스튜던트 ] 뫼르소", rank: 3, img: "05_meursault_yasu.png" }
    ],
    "홍루": [
        ...
        { name: "[ 거미집 약지 아비 ] 홍루", rank: 3, img: "06_hong_lu_spider.png" }
    ],
    "히스클리프": [
